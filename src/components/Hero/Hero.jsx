...
const Hero = () => {
  return (
    <section
      className={`${s.heroSection} bg-hero pt-[105px] pb-14 tablet:pt-[124px] tablet:pb-16`}
    >
      <div className='content-container'>
        <div className='relative'>
          ...
          <div className='tablet:absolute tablet:bottom-0 tablet:right-0'>
            ...
            <a
              href='#'
              className={`${s.joinButton} max-w-[280px] flex items-center justify-center relative text-18 text-white font-bold uppercase py-[18px] px-16 bg-backgroundDefault m-auto tablet:max-w-[230px] tablet:py-[14px] desktop:max-w-[295px] desktop:py-4`}
            >
              Join now
            </a>
          </div>
